# 4C Research Website - Complete Overhaul TODO

## 🚨 URGENT - Website Does Not Meet Requirements

Based on detailed email requirements, current website needs complete content and structural overhaul.
...
- [ ] **Ethics of research in Disorders of Consciousness** - Add upcoming papers
- [ ] **GERMINAL project** - Add Radboud-Western funding, complex decision making focus
...
- [ ] **BrainCASH study** - Add healthcare provider sleep deprivation research
- [ ] **BrainCASH-2 study** - Add Sunny Kim resident project details
- [ ] **EEG-based machine learning framework** - Add Daya Kumar/Dr. Narayan collaboration, Frontiers in Physiology review
...
- [ ] **Add current members**: Hashmeet, Saanvi Mittal
...
- [ ] **Add team collaboration photos** in relevant sections
...
- [ ] **Conference presentation gallery** - Knowledge mobilization
...
1. **Hero section imagery replacement** (EEG/fNIRS scans)
2. **Alumni section creation** (multiple people to add)
3. **Real project content** (replace all placeholder data)
4. **External institution links** (LHSC, Schulich, etc.)
5. **Publication auto-feed integration**

---

## 📈 **SUCCESS METRICS**

- [ ] All email requirements implemented
- [ ] Real research data replaces placeholder content
- [ ] Alumni section complete with all mentioned members
- [ ] External links functional and integrated
- [ ] Publication feed auto-updating
- [ ] "Foresee" visual theme consistently applied
- [ ] All images are real lab photos/scans

---

**Current Compliance: 20% → Target: 100%**
